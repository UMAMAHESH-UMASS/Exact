...
public class Login {
 ...
 public void beforeExecution() throws IOException
  {
	//runmode of the test Y or N
	  if(Testutil.isSkip(BaseTest.datatable_suite1, "Scenario_002"))
	  {
	   //skip the test
 ...
 public void sendMail() throws Exception
  {
    //Zip.zipFolder("F:\\Selenium_Scripts_Oct14\\DataDrivenFramework\\test-output","F:\\Selenium_Scripts_Oct14\\DataDrivenFramework\\Results\\"+"Target Reports.zip");    
    Zip.zipFolder(System.getProperty("user.dir")+"\\test-output",System.getProperty("user.dir")+"\\Results\\"+"Target Reports.zip");
              ...
              SendMail.sendMailTo("qtt.selenium.sep@gmail.com",
                                  ...
                                  to,
                                   cc,
                                  bcc,
                                  "Target Automation Login page Reports",
                                  "Please find the reports attached in the mail.\n\n Regards\nWebMaster",
                                    System.getProperty("user.dir")+ "\\Results"+"\\Target Reports.zip",
                                  "Target Login Reports.zip"); 
 }
